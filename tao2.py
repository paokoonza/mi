...
#==================================================
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki1.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki1.leaveGroup(msg.to)
                        ki2.sendText(msg.to,"ไปก็ได้ Bye~..😭 "  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki2.leaveGroup(msg.to)
                        ki3.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki3.leaveGroup(msg.to)
                        ki4.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki4.leaveGroup(msg.to)
                        ki5.sendText(msg.to,"ไปก็ไก้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki5.leaveGroup(msg.to)
                        ki6.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki6.leaveGroup(msg.to)
                        ki7.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki7.leaveGroup(msg.to)
                        ki8.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki8.leaveGroup(msg.to)
                        ki9.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
                        ki9.leaveGroup(msg.to)
                        ki10.sendText(msg.to,"ไปก็ได้ Bye~..😭 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ✯͜͡ຖ ຸงເທ ົາ͜͜͜͡✯]")
...
#===============================================
                ...
                cl.sendText(msg.to, "ความเร็ว / วินาที....👍")
                start = time.time()
                time.sleep(0.001)
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cnt.to = msg.to
                cl.sendMessage(cnt)
            elif msg.text in [".อยู่มั้ย"]:
                        cl.sendText(msg.to,"อยู่ไม่อยู่ก็เรื่องของกู...😑")
