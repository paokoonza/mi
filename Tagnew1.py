...
cl = LINETCR.LINE()
cl.login(token="EpYTY9FjwXTN949U3Fz9.nnBoNbIlLHC3yh3xiCI2kq.f2m7Wg/kaE9kijWuhDOAgCtKe+yk/0tuPCbdbNjLrB8=")
cl.loginResult()
ki=ki2=ki3=ki4=cl
            ...
            if msg.toType == 0:
                ...
                if msg.from_ == "u2a51caa84881dbc51b62282a030664ba":
                    if "join:" in msg.text:
                        ...
                        cl.sendText(msg.to,"คุยจนเมียจับได้อิอิ...")
            elif msg.text in ["อยู่ไหม",".อยู่ไหม","อยู่มั้ย"]:
                        cl.sendText(msg.to,"...อยู่")             
            elif msg.text in ["5555","อิอิ","55555"]:
                        cl.sendText(msg.to,"หราาา")
            elif msg.text in ["มด","พี่มด","มดหาย"]:
                        cl.sendText(msg.to,"ครับพี่มดไม่ว่างคุยกับพี่เจนอยู่..")
            elif msg.text in ["จาร",".พี่ท๊อป","ท๊อป"]:
                        cl.sendText(msg.to,"ครับพี่ท๊อปก็ไม่ว่างยุ่งเรื่องเชิฟอยู่....")                                             
            if msg.toType == 1:
                if wait["leaveRoom"] == True:
                    cl.leaveRoom(msg.to)
