...
#======================================================#
                        ...
                        cl.sendText(msg.to,"มินไม่ว่างคุยสาวอยู่")
                        
            elif "[Auto Respond]" in msg.text:
                cl.sendImageWithUrl(msg.to, "http://dl.profile.line-cdn.net/0hX1b058ZGBx5fSSsJJLd4SWMMCXMoZwFWJ39IKilODSd3fRccanhLf39ODnp7KUQaZydIeHNMWXki")                        
                
            elif "#+1" in msg.text:
                cl.sendImageWithUrl(msg.to, "http://dl.profile.line-cdn.net/0hX1b0LORDBx5fSSsJBqp4SWMMCXMoZwFWJ39IKilODSd3fRccanhLf39ODnp7KUQaZydIeHNMWXki")      

            elif msg.text in ["ล็อค","ล็อคบ้าน","ปิดบ้าน"]:
            ...
            elif msg.text in ["เปลียนแอด","สร้างแอด","เพิ่มแอด"]:
                        cl.sendText(msg.to,"set:changeowner")
                        cl.sendText(msg.to,"เปลี่ยนเจ้าของห้องสั่งแล้วส่งคอลแทคคนที่จะเป็นเจ้าของห้องคนต่อไปลงในกลุ่ม")                        


            elif msg.text in ["ยัดดำ","ดำ"]:
                        cl.sendText(msg.to,"set:addblacklist")
                        cl.sendText(msg.to,"บัญชีดำแบ็คลิสคนไม่ให้เข้ากลุ่มสั่งแล้วส่งคอลแทคคนที่เราจะแบ็คลิสลงในกลุ่ม")                        
                                  
            elif msg.text in ["ขาว","เพิ่มขาว","ยัดดำ"]:
                        cl.sendText(msg.to,"set:addwhitelist")
                        cl.sendText(msg.to,"บัญชีขาวแก้ดำสั่งแล้วส่งคอลแทคคนที่เราจะแก้แบ๊คลิสลงในกลุ่ม")                        
            ...
            elif msg.text in ["เปิดลิ้ง","ลิ้งกลุ่ม","เปิดลิ้งกลุ่ม"]:
                        cl.sendText(msg.to,"Siri:inviteurl")


            elif msg.text in ["ปิดลิ้ง","ปิดลิ้งกลุ่ม"]:
                        cl.sendText(msg.to,"Siri:DenyURLInvite")


            elif msg.text in ["คำสั่งบอทมิน","บอทมิน","มินV10"]:
                        cl.sendText(msg.to,"👉ปิดลิ้ง")
                        cl.sendText(msg.to,"👉เปิดลิ้ง")                        
                        cl.sendText(msg.to,"👉เปิดเชิญ")
                        cl.sendText(msg.to,"👉ปิดเชิญ")
                        cl.sendText(msg.to,"👉เปลียนแอด")
                        cl.sendText(msg.to,"👉ขาว")                        
                        cl.sendText(msg.to,"👉ดำ")
                        cl.sendText(msg.to,"👉ล็อคบ้าน")
                        cl.sendText(msg.to,"👉หมดแล้วขี้เกียจเพิ่ม")
                        cl.sendText(msg.to,"👉5555")                        
                        cl.sendText(msg.to,"👉ไรต่อดีวะ")
                        cl.sendText(msg.to,"👉ช่างแม่งจบเหอะ")                        
#======================================================#
#======================================================#
